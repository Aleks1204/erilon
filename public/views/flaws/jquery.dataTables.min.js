...
sessionStorage:localStorage).getItem("DataTables_"+a.sInstance+"_"+location.pathname))}catch(b){}},fnStateLoadParams:null,fnStateLoaded:null,fnStateSaveCallback:function(a,b){try{(-1===a.iStateDuration?sessionStorage:localStorage).setItem("DataTables_"+a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": активировать сортирование столбцов по возрастанию",
sSortDescending:": активировать сортирование столбцов по убыванию"},oPaginate:{sFirst:"Первый",sLast:"Последний",sNext:"Вперед",sPrevious:"Предыдущий"},sEmptyTable:"Данные в таблице отсутствуют",sInfo:"Показать от _START_ до _END_ из _TOTAL_ записей",sInfoEmpty:"Показать от 0 до 0 из 0 записей",sInfoFiltered:"(Фильтр из _MAX_ общих записей)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Показать _MENU_ значений",sLoadingRecords:"Загружаю...",sProcessing:"Подожди...",sSearch:"Искать недостатки:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Совпадающих записей не найдено"},
